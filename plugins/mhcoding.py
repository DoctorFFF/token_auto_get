...
PLUGIN_NAME = "mhcoding"
PLUGIN_TITLE = "MHCoding"
PLUGIN_URL = "https://www.mhcoding.xyz"
PLUGIN_DESC = "MHCoding 站点自动签到插件。使用前请先在官网注册账号。"


def run(username, password):
    login_url = "https://www.mhcoding.xyz/api/user/login?turnstile="
    checkin_url = "https://www.mhcoding.xyz/api/user/checkin"

    month = datetime.now().strftime("%Y-%m")
    history_url = f"https://www.mhcoding.xyz/api/user/checkin?month={month}"

    base_headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36",
        "Origin": "https://www.mhcoding.xyz",
        "Referer": "https://www.mhcoding.xyz/console/personal",
